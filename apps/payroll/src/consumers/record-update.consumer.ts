...
/**
 * BUG-0003 — RecordUpdated consumer (payroll half). A workflow `assign_team` / `add_tag` rule action
 ...
 *
 * This worker-role consumer (the payroll half of a per-service triple, mirroring the ApprovalCompleted
 * consumers) applies the annotation to the pay run it OWNS, under the RequestContext the bus rebuilt
