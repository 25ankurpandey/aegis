...
/**
 * BUG-0003 — RecordUpdated consumer (expense half). A workflow `assign_team` / `add_tag` rule action
 ...
 *
 * This worker-role consumer (the expense half of a per-service triple, mirroring the ApprovalCompleted
 * consumers) applies the annotation to the report it OWNS, under the RequestContext the bus rebuilt
